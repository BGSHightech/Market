...
public class ClientServiceImpl implements ClientService {
     ...
     */
    @Override
    public CreateClientResponseDTO createClient(CreateClientRequestDTO request) throws Exception {
        // Show the request in the console.
     ...
     */
    @Override
    public UpdateClientResponseDTO updateClient(UpdateClientRequestDTO request) throws Exception {
        // Show the request in the console.
        System.out.println("request = " + new Gson().toJson(request));
        ...
        existingClient.setClientId(request.getClientId());
